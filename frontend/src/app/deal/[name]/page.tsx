      ...
      <main className="p-4 space-y-6 pb-24">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-3">
            <p className="text-gray-900">{company.DealNotes || "Strong performance metrics with consistent growth trajectory. Team has proven execution capabilities."}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-4">
            <div>
              <h4 className="font-semibold mb-2 text-gray-900">ARR Growth vs. Sector</h4>
              {/* Placeholder for dynamic benchmark rendering */}
            </div>
            <div className="border-t border-gray-200 pt-4">
              <h4 className="font-semibold mb-2 text-gray-900">Key Competitors</h4>
              <p className="text-gray-900">{company.Competitors || 'No competitor information available.'}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-3">
            <p className="text-gray-900">{company.ExitStrategy || 'No exit strategy analysis available.'}</p>
          </div>
        </div>
